...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [WIN_BASE] = LAYOUT_ansi_89(
        ...
        _______,  KC_INS,  KC_A,     KC_S,     KC_D,     KC_F,     KC_G,      KC_H,     KC_J,     KC_K,     KC_L,     KC_SCLN,  KC_QUOT,            KC_ENT,             KC_END,
        _______,  KC_LSFT,            KC_Z,     KC_X,     KC_C,     KC_V,      KC_B,     KC_B,     KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,  KC_RSFT,  KC_UP,
        _______,  KC_LCTL,  KC_LWIN,            KC_LALT,  KC_SPC,  MO(WIN_FN),                     KC_SPC,             KC_RCTL,                      KC_LEFT,  KC_DOWN,  KC_RGHT),
    ...
    [WIN_FN] = LAYOUT_ansi_89(
        ...
        _______,  _______,            _______,  _______,  _______,  _______,   _______,  _______,  NK_TOGG,  KC_P1,  KC_P2,  KC_P3,   KC_PDOT,  _______,  _______,
        _______,  _______,  _______,            _______,  _______,  _______,                       KC_P0,            KC_RALT,                       _______,  _______,  _______),
};
